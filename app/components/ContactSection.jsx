        ...
        <div id="contact" className="relative min-h-screen bg-[#0a0a0a] text-white pt-24 pb-12 overflow-hidden border-t border-white/5 flex flex-col justify-between">
            ...
            <div className="relative z-20 container mx-auto px-6 max-w-6xl flex-grow flex flex-col justify-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
                    ...
                    <a href="mailto:albertfreixa10@gmail.com" className="group relative bg-[#111] rounded-2xl p-8 border border-white/5 hover:border-blue-500/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_10px_40px_rgba(59,130,246,0.1)] flex flex-col items-center text-center">
                        <div className="w-16 h-16 bg-blue-500/10 rounded-full flex items-center justify-center text-blue-500 mb-6 group-hover:bg-blue-500 group-hover:text-white transition-colors duration-300">
                            <MailIcon />
                        </div>
                        <h4 className="text-xl font-bold uppercase italic tracking-wide mb-2">Email</h4>
                        <p className="text-gray-400 text-sm mb-6">For official club proposals and detailed documentation.</p>
                        <span className="text-white font-mono text-sm border-b border-white/20 pb-1 group-hover:border-blue-500 transition-colors">albertfreixa10@gmail.com</span>
                    </a>
                    ...
                    <a href="https://wa.me/34629638725" target="_blank" rel="noopener noreferrer" className="group relative bg-[#111] rounded-2xl p-8 border border-white/5 hover:border-green-500/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_10px_40px_rgba(34,197,94,0.1)] flex flex-col items-center text-center">
                        <div className="w-16 h-16 bg-green-500/10 rounded-full flex items-center justify-center text-green-500 mb-6 group-hover:bg-green-500 group-hover:text-white transition-colors duration-300">
                            <WhatsAppIcon />
                        </div>
                        <h4 className="text-xl font-bold uppercase italic tracking-wide mb-2">WhatsApp</h4>
                        <p className="text-gray-400 text-sm mb-6">Direct contact for agents and quick inquiries.</p>
                        <span className="text-white font-mono text-sm border-b border-white/20 pb-1 group-hover:border-green-500 transition-colors flex items-center gap-2">+34 629 638 725 <ArrowUpRight /></span>
                    </a>
                    ...
                    <a href="https://instagram.com/freeixa" target="_blank" rel="noopener noreferrer" className="group relative bg-[#111] rounded-2xl p-8 border border-white/5 hover:border-pink-500/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_10px_40px_rgba(236,72,153,0.1)] flex flex-col items-center text-center">
                        <div className="w-16 h-16 bg-pink-500/10 rounded-full flex items-center justify-center text-pink-500 mb-6 group-hover:bg-pink-500 group-hover:text-white transition-colors duration-300">
                            <InstagramIcon />
                        </div>
                        <h4 className="text-xl font-bold uppercase italic tracking-wide mb-2">Instagram</h4>
                        <p className="text-gray-400 text-sm mb-6">Follow the daily routine and match highlights.</p>
                        <span className="text-white font-mono text-sm border-b border-white/20 pb-1 group-hover:border-pink-500 transition-colors flex items-center gap-2">@freeixa <ArrowUpRight /></span>
                    </a>
                </div>
            </div>
            ...
            <footer className="mt-24 border-t border-white/10 bg-black pt-12 pb-8">
                <div className="container mx-auto px-6 text-center space-y-4">
                    ...
                    {/* Developer Credit */}
                    <div className="pt-2 text-[10px] text-gray-800 font-mono flex items-center justify-center gap-2">
                        <span>Designed & Built by</span>
                        <a
                            href="https://instagram.com/linusnicolau"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-gray-700 hover:text-white transition-colors border-b border-transparent hover:border-white/20 pb-0.5"
                        >
                            Linus Nicolau
                        </a>
                    </div>
