...
export default function HeroSection() {
    return (
        <div id="hero" className="relative min-h-[100dvh] bg-[#0a0a0a] text-white overflow-hidden font-sans selection:bg-white selection:text-black flex flex-col">
            ...
            {/* MAIN CONTENT */}
            <main className="relative z-10 container mx-auto flex-grow grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-4 px-4 sm:px-6 pb-0 h-full">

                {/* TEXTO IZQUIERDA */}
                <div className="lg:col-span-4 flex flex-col justify-center space-y-6 z-30 order-1 text-center lg:text-left self-center mt-24 lg:mt-0">
                    <div className="space-y-1">
                        <h2 className="text-blue-500 font-bold tracking-widest uppercase text-xs md:text-sm">Professional Footballer</h2>
                        <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black uppercase leading-[0.9] italic drop-shadow-xl">
                    ...
                    <div className="pt-2">
                        ...
                        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-2 gap-y-2 text-sm text-gray-300 text-left max-w-sm mx-auto lg:mx-0 font-medium justify-center lg:justify-start inline-grid lg:grid">
                    ...
                    <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 pt-2">
                        <a href="https://instagram.com/freeixa" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-full hover:bg-white/20 transition-all border border-white/10 text-white text-xs uppercase tracking-wider backdrop-blur-md">
                            <InstagramIcon /> <span className="sm:inline">@freeixa</span>
                        </a>
                        <a href="https://www.transfermarkt.es/albert-freixa/profil/spieler/1318898?fbclid=PAQ0xDSwLd2Y5leHRuA2FlbQIxMQABp0hWsnaQ2sD4At8X10xFHoka71nxM8JReqdnl7SM2woy0k7-Okut7s5TAc2C_aem_Q_Qg6h2jNv4ATwAG7NqrgA" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-full hover:bg-white/20 transition-all border border-white/10 text-white text-xs uppercase tracking-wider backdrop-blur-md">
                            <ExternalLinkIcon /> <span className="sm:inline">Transfermarkt</span>
                        </a>
                    </div>
                </div>
                ...
                {/* Ajustes realizados:
                    1. Altura base reducida a h-[55vh] en móvil y h-[85vh] en desktop para evitar overflow.
                    2. Escalas más controladas: lg:scale-135 en lugar de 195. 
                    3. Se añade xl:scale-150 y 2xl:scale-175 para que SOLO crezca en pantallas MUY grandes.
                */}
                <div className="lg:col-span-4 relative h-[55vh] lg:h-[100vh] flex items-end justify-center z-10 order-2 lg:order-2 -mx-6 lg:mx-0 pointer-events-none self-end">
                    ...
                    <img
                        src="/albert-freixa-hero.png"
                        alt="Albert Freixa"
                        className="h-full w-auto object-contain object-bottom scale-x-[-1] scale-100 lg:scale-135 xl:scale-150 2xl:scale-175 origin-bottom drop-shadow-[0_0_35px_rgba(59,130,246,0.5)] relative z-10 lg:h-[85%] xl:h-[90%]"
                    />
                </div>

                {/* STATS DERECHA */}
                <div className="lg:col-span-4 flex flex-col justify-center items-center lg:items-end z-30 order-3 w-full self-center mb-12 lg:mb-0 lg:ml-12">
                    <div className="w-full max-w-sm sm:max-w-md bg-[#111]/70 backdrop-blur-xl border border-white/10 rounded-2xl p-5 shadow-2xl relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex flex-col sm:flex-row gap-6 sm:gap-4">
                                <div className="w-full sm:w-1/3 flex flex-col justify-center items-center sm:items-stretch">
                                    <div className="w-2/3 sm:w-full">
                                        <TacticalBoard />
                                    </div>
                                    <p className="text-[9px] text-center text-gray-500 mt-2 uppercase tracking-wide">Pref. Zones</p>
                                </div>

                                <div className="w-full sm:w-2/3 grid grid-cols-2 gap-3 content-center">
                            ...
                            <div className="mt-6 pt-3 border-t border-white/10 flex justify-between items-center">
                                <div className="text-[10px] text-gray-500 max-w-[60%] truncate">Teams: <span className="text-gray-300">Ordino, Llosetense, Can Gibert...</span></div>
                                <button onClick={(e) => scrollToSection(e, 'stats')} className="text-[10px] bg-white text-black px-3 py-1 rounded font-bold uppercase hover:bg-gray-200 transition-colors cursor-pointer whitespace-nowrap">Full Profile</button>
                            </div>
                        </div>
                    </div>
                </div>
